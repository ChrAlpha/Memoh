...
export const getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdContextLifecycleByRunId', options);

/**
 * Get one session context lifecycle turn
 *
 * Return the full persisted lifecycle snapshot of one run, including the per-fragment selection_decisions the list endpoint omits. Sessions predating run lifecycle persistence fall back to legacy assistant metadata
 */
export const getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdQuery = defineQueryOptions<Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdData>, GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdResponse, GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdError>((options: Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdData>) => ({
    key: getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdQueryKey(options),
    query: async (context) => {
