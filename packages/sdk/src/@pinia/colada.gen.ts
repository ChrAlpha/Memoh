...
export const getBotsByBotIdSessionsBySessionIdCompactionsQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdCompactionsData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdCompactions', options);
...
export const getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisions', options);

/**
 * Get per-fragment selection decisions of a run
 *
 * Return the content-light selection audit persisted for one run of a chat session: each fragment the context selector considered with its slot, source, token cost and decision. The list is read on demand because it grows with the history the run considered
 */
export const getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsQuery = defineQueryOptions<Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsData>, GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsResponse, GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsError>((options: Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsData>) => ({
    key: getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdDecisionsQueryKey(options),
    query: async (context) => {
...
export const getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragments', options);

/**
 * Get the injected context texts of a run
 *
 * Return every fragment the run put in front of the model outside the conversation (system prompt pieces, workspace rules, tool usage, skills, recalled memory, tool definitions) with the text that was stored for it. Conversation messages are not included; the history holds them. The texts include workspace files and hook output, so the caller needs workspace_read on the bot besides access to the session
 */
export const getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsQuery = defineQueryOptions<Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsData>, GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsResponse, GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsError>((options: Options<GetBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsData>) => ({
    key: getBotsByBotIdSessionsBySessionIdContextLifecycleByRunIdFragmentsQueryKey(options),
    query: async (context) => {
