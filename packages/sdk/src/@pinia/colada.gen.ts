 ...
 */
export const getBotsByBotIdAcpClaudeCodeOauthAuthorizeQuery = defineQueryOptions<Options<GetBotsByBotIdAcpClaudeCodeOauthAuthorizeData>, GetBotsByBotIdAcpClaudeCodeOauthAuthorizeResponse, GetBotsByBotIdAcpClaudeCodeOauthAuthorizeError>((options: Options<GetBotsByBotIdAcpClaudeCodeOauthAuthorizeData>) => ({
 ...
 */
export const getBotsByBotIdAcpClaudeCodeOauthStatusQuery = defineQueryOptions<Options<GetBotsByBotIdAcpClaudeCodeOauthStatusData>, GetBotsByBotIdAcpClaudeCodeOauthStatusResponse, GetBotsByBotIdAcpClaudeCodeOauthStatusError>((options: Options<GetBotsByBotIdAcpClaudeCodeOauthStatusData>) => ({
...
export const getBotsByBotIdAcpCodexOauthAuthorizeQueryKey = (options: Options<GetBotsByBotIdAcpCodexOauthAuthorizeData>) => createQueryKey('getBotsByBotIdAcpCodexOauthAuthorize', options);

/**
 * Start Codex ACP OAuth authorization
 */
export const getBotsByBotIdAcpCodexOauthAuthorizeQuery = defineQueryOptions<Options<GetBotsByBotIdAcpCodexOauthAuthorizeData>, GetBotsByBotIdAcpCodexOauthAuthorizeResponse, GetBotsByBotIdAcpCodexOauthAuthorizeError>((options: Options<GetBotsByBotIdAcpCodexOauthAuthorizeData>) => ({
    key: getBotsByBotIdAcpCodexOauthAuthorizeQueryKey(options),
    query: async (context) => {
 ...
 */
export const postBotsByBotIdAcpCodexOauthDeviceAuthorizeMutation = (options?: Partial<Options<PostBotsByBotIdAcpCodexOauthDeviceAuthorizeData>>): UseMutationOptions<PostBotsByBotIdAcpCodexOauthDeviceAuthorizeResponse, Options<PostBotsByBotIdAcpCodexOauthDeviceAuthorizeData>, PostBotsByBotIdAcpCodexOauthDeviceAuthorizeError> => ({
    mutation: async (vars) => {
 ...
 */
export const postBotsByBotIdAcpCodexOauthDeviceCancelMutation = (options?: Partial<Options<PostBotsByBotIdAcpCodexOauthDeviceCancelData>>): UseMutationOptions<PostBotsByBotIdAcpCodexOauthDeviceCancelResponse, Options<PostBotsByBotIdAcpCodexOauthDeviceCancelData>, PostBotsByBotIdAcpCodexOauthDeviceCancelError> => ({
    mutation: async (vars) => {
 ...
 */
export const postBotsByBotIdAcpCodexOauthDevicePollMutation = (options?: Partial<Options<PostBotsByBotIdAcpCodexOauthDevicePollData>>): UseMutationOptions<PostBotsByBotIdAcpCodexOauthDevicePollResponse, Options<PostBotsByBotIdAcpCodexOauthDevicePollData>, PostBotsByBotIdAcpCodexOauthDevicePollError> => ({
    mutation: async (vars) => {
...
export const getBotsByBotIdAcpCodexOauthStatusQueryKey = (options: Options<GetBotsByBotIdAcpCodexOauthStatusData>) => createQueryKey('getBotsByBotIdAcpCodexOauthStatus', options);

/**
 * Get Codex ACP OAuth status
 */
export const getBotsByBotIdAcpCodexOauthStatusQuery = defineQueryOptions<Options<GetBotsByBotIdAcpCodexOauthStatusData>, GetBotsByBotIdAcpCodexOauthStatusResponse, GetBotsByBotIdAcpCodexOauthStatusError>((options: Options<GetBotsByBotIdAcpCodexOauthStatusData>) => ({
    key: getBotsByBotIdAcpCodexOauthStatusQueryKey(options),
    query: async (context) => {
 ...
 */
export const getBotsByBotIdHeartbeatLogsQuery = defineQueryOptions<Options<GetBotsByBotIdHeartbeatLogsData>, GetBotsByBotIdHeartbeatLogsResponse, GetBotsByBotIdHeartbeatLogsError>((options: Options<GetBotsByBotIdHeartbeatLogsData>) => ({
 ...
 */
export const getBotsByBotIdMcpExportQuery = defineQueryOptions<Options<GetBotsByBotIdMcpExportData>, GetBotsByBotIdMcpExportResponse, GetBotsByBotIdMcpExportError>((options?: Options<GetBotsByBotIdMcpExportData>) => ({
...
export const getBotsByBotIdPluginsQueryKey = (options: Options<GetBotsByBotIdPluginsData>) => createQueryKey('getBotsByBotIdPlugins', options);

/**
 * List bot plugins
 */
export const getBotsByBotIdPluginsQuery = defineQueryOptions<Options<GetBotsByBotIdPluginsData>, GetBotsByBotIdPluginsResponse, GetBotsByBotIdPluginsError>((options: Options<GetBotsByBotIdPluginsData>) => ({
    key: getBotsByBotIdPluginsQueryKey(options),
    query: async (context) => {
 ...
 */
export const deleteBotsByBotIdPluginsByIdMutation = (options?: Partial<Options<DeleteBotsByBotIdPluginsByIdData>>): UseMutationOptions<unknown, Options<DeleteBotsByBotIdPluginsByIdData>, DeleteBotsByBotIdPluginsByIdError> => ({
    mutation: async (vars) => {
        const { data } = await deleteBotsByBotIdPluginsById({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByBotIdPluginsByIdQueryKey = (options: Options<GetBotsByBotIdPluginsByIdData>) => createQueryKey('getBotsByBotIdPluginsById', options);

/**
 * Get bot plugin installation
 */
export const getBotsByBotIdPluginsByIdQuery = defineQueryOptions<Options<GetBotsByBotIdPluginsByIdData>, GetBotsByBotIdPluginsByIdResponse, GetBotsByBotIdPluginsByIdError>((options: Options<GetBotsByBotIdPluginsByIdData>) => ({
    key: getBotsByBotIdPluginsByIdQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdPluginsById({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 * Disable bot plugin
 */
export const postBotsByBotIdPluginsByIdDisableMutation = (options?: Partial<Options<PostBotsByBotIdPluginsByIdDisableData>>): UseMutationOptions<PostBotsByBotIdPluginsByIdDisableResponse, Options<PostBotsByBotIdPluginsByIdDisableData>, PostBotsByBotIdPluginsByIdDisableError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdPluginsByIdDisable({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 * Enable bot plugin
 */
export const postBotsByBotIdPluginsByIdEnableMutation = (options?: Partial<Options<PostBotsByBotIdPluginsByIdEnableData>>): UseMutationOptions<PostBotsByBotIdPluginsByIdEnableResponse, Options<PostBotsByBotIdPluginsByIdEnableData>, PostBotsByBotIdPluginsByIdEnableError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdPluginsByIdEnable({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 */
export const postBotsByBotIdPluginsByIdOauthAuthorizeMutation = (options?: Partial<Options<PostBotsByBotIdPluginsByIdOauthAuthorizeData>>): UseMutationOptions<PostBotsByBotIdPluginsByIdOauthAuthorizeResponse, Options<PostBotsByBotIdPluginsByIdOauthAuthorizeData>, PostBotsByBotIdPluginsByIdOauthAuthorizeError> => ({
    mutation: async (vars) => {
...
export const getBotsByBotIdPluginsByIdOauthStatusQueryKey = (options: Options<GetBotsByBotIdPluginsByIdOauthStatusData>) => createQueryKey('getBotsByBotIdPluginsByIdOauthStatus', options);

/**
 * Refresh managed OAuth status for a bot plugin
 */
export const getBotsByBotIdPluginsByIdOauthStatusQuery = defineQueryOptions<Options<GetBotsByBotIdPluginsByIdOauthStatusData>, GetBotsByBotIdPluginsByIdOauthStatusResponse, GetBotsByBotIdPluginsByIdOauthStatusError>((options: Options<GetBotsByBotIdPluginsByIdOauthStatusData>) => ({
    key: getBotsByBotIdPluginsByIdOauthStatusQueryKey(options),
    query: async (context) => {
 ...
 */
export const postBotsByBotIdPluginsByIdUninstallMutation = (options?: Partial<Options<PostBotsByBotIdPluginsByIdUninstallData>>): UseMutationOptions<PostBotsByBotIdPluginsByIdUninstallResponse, Options<PostBotsByBotIdPluginsByIdUninstallData>, PostBotsByBotIdPluginsByIdUninstallError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdPluginsByIdUninstall({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 *
 * List run-keyed context lifecycle snapshots (selection, cache plan, mutations, cache attribution) for a chat session with aggregated cache and drop statistics; pre-run-table sessions fall back to legacy assistant metadata
 */
 ...
 */
export const postBotsByBotIdSupermarketInstallPluginMutation = (options?: Partial<Options<PostBotsByBotIdSupermarketInstallPluginData>>): UseMutationOptions<PostBotsByBotIdSupermarketInstallPluginResponse, Options<PostBotsByBotIdSupermarketInstallPluginData>, PostBotsByBotIdSupermarketInstallPluginError> => ({
    mutation: async (vars) => {
...
export const getSupermarketPluginsQueryKey = (options?: Options<GetSupermarketPluginsData>) => createQueryKey('getSupermarketPlugins', options);

/**
 * List plugins from supermarket
 */
export const getSupermarketPluginsQuery = defineQueryOptions<Options<GetSupermarketPluginsData>, GetSupermarketPluginsResponse, GetSupermarketPluginsError>((options?: Options<GetSupermarketPluginsData>) => ({
    key: getSupermarketPluginsQueryKey(options),
    query: async (context) => {
...
export const getSupermarketPluginsByIdQueryKey = (options: Options<GetSupermarketPluginsByIdData>) => createQueryKey('getSupermarketPluginsById', options);

/**
 * Get plugin detail from supermarket
 */
export const getSupermarketPluginsByIdQuery = defineQueryOptions<Options<GetSupermarketPluginsByIdData>, GetSupermarketPluginsByIdResponse, GetSupermarketPluginsByIdError>((options: Options<GetSupermarketPluginsByIdData>) => ({
    key: getSupermarketPluginsByIdQueryKey(options),
    query: async (context) => {
 ...
 */
export const getSupermarketSkillsByIdQuery = defineQueryOptions<Options<GetSupermarketSkillsByIdData>, GetSupermarketSkillsByIdResponse, GetSupermarketSkillsByIdError>((options: Options<GetSupermarketSkillsByIdData>) => ({
 ...
 */
export const getSupermarketTagsQuery = defineQueryOptions<Options<GetSupermarketTagsData>, GetSupermarketTagsResponse, GetSupermarketTagsError>((options?: Options<GetSupermarketTagsData>) => ({
