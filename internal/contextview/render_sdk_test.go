...
func TestSDKRenderer_SystemRenderGroupsUseDeclaredJoiners(t *testing.T) {
	t.Parallel()
	...
	frags := []contextfrag.ContextFrag{
		...
		textFrag("system.workspace_file.AGENTS.md", contextfrag.SlotSystem, contextfrag.KindWorkspaceInstruction, sdk.MessageRoleSystem, "## AGENTS.md\n\ninstructions"),
	}
