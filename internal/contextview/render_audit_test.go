...
func TestAuditRenderer_CapturesManifestAndVisibleTrace(t *testing.T) {
	...
	scope := contextfrag.Scope{BotID: "bot-1", SessionID: "session-1", TurnID: "turn-1"}
...
func TestAuditRenderer_ScopeAndIntent(t *testing.T) {
	...
	scope := contextfrag.Scope{BotID: "bot-1", ChatID: "chat-1", SessionID: "session-1", TurnID: "turn-1"}
