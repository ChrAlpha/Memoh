...
func (s *Service) StoreRound(ctx context.Context, botID, sessionID, channelIdentityID, currentPlatform string, sdkMessages []sdk.Message, modelID string) error {
	return s.StoreRoundWithContextLifecycle(ctx, botID, sessionID, channelIdentityID, currentPlatform, sdkMessages, modelID, nil)
}

func (s *Service) StoreRoundWithContextLifecycle(ctx context.Context, botID, sessionID, channelIdentityID, currentPlatform string, sdkMessages []sdk.Message, modelID string, lifecycle *contextfrag.LifecycleHolder) error {
	...
	return s.storeRoundWithOptions(ctx, req, modelMessages, modelID, storeRoundOptions{ContextLifecycle: lifecycle})
}
