...
func (s *Service) persistACPRound(ctx context.Context, req ChatRequest, agentID, projectPath string, result acpclient.PromptResult, promptErr error, contextLifecycle *contextfrag.LifecycleHolder) error {
	meta := map[string]any{
