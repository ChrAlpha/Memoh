...
func TestBudgetTrim_DropsLeadingOrphanTool(t *testing.T) {
	...
	history := []ModelMessage{
		{Role: "user", Content: newTextContent("1111")},
		{
			Role: "assistant",
			ToolCalls: []ToolCall{{
				ID:   "call-1",
		...
		{Role: "tool", ToolCallID: "call-1", Content: newTextContent("2")},
...
func TestBudgetTrim_CutoffAdvancesPastPairedTool(t *testing.T) {
	...
	history := []ModelMessage{
		...
		{Role: "user", Content: newTextContent("next question")},
	}
...
func TestBudgetTrim_UnderBudgetKeepsAll(t *testing.T) {
	...
	history := []ModelMessage{
		...
		{Role: "assistant", Content: newTextContent("hi")},
	}
...
func TestBudgetTrim_SmallBudgetTrimsButProtectsLatestUserTurn(t *testing.T) {
	...
	history := []ModelMessage{
		{Role: "user", Content: newTextContent("old message")},
		{Role: "assistant", Content: newTextContent("old reply")},
		{Role: "user", Content: newTextContent("new message")},
		{Role: "assistant", Content: newTextContent("new reply")},
	}
...
func TestBudgetTrim_NoticeContentMatchesLegacyWording(t *testing.T) {
	...
	history := []ModelMessage{
		{Role: "user", Content: newTextContent(long)},
		{Role: "assistant", Content: newTextContent("ok")},
		{Role: "user", Content: newTextContent("next")},
	}
