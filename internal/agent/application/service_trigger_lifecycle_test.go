...
func (p *triggerLifecycleProvider) DoGenerate(
	...
	return &sdk.GenerateResult{
		Text:         "HEARTBEAT_OK " + directLifecycleResponse,
		FinishReason: sdk.FinishReasonStop,
		Messages: []sdk.Message{
			sdk.AssistantMessage("HEARTBEAT_OK " + directLifecycleResponse),
		},
	}, nil
}
...
func assertDeferredLifecycleRow(
	...
	for _, privateText := range []string{directLifecyclePrompt, directLifecycleResponse, "HEARTBEAT_OK"} {
