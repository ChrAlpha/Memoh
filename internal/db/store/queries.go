...
type Queries interface {
	...
	GetAssistantContextLifecycleBySessionAndRunID(ctx context.Context, arg dbsqlc.GetAssistantContextLifecycleBySessionAndRunIDParams) (dbsqlc.GetAssistantContextLifecycleBySessionAndRunIDRow, error)
	GetContextLifecycleByRunID(ctx context.Context, runID pgtype.UUID) (dbsqlc.ContextLifecycle, error)
	GetContextLifecycleBySessionAndRunID(ctx context.Context, arg dbsqlc.GetContextLifecycleBySessionAndRunIDParams) (dbsqlc.GetContextLifecycleBySessionAndRunIDRow, error)
