...
const (
	...
	ContainerService_ReverseHTTP_FullMethodName      = "/bridgepb.ContainerService/ReverseHTTP"
	...
	ContainerService_ReadRawNoFollow_FullMethodName  = "/bridgepb.ContainerService/ReadRawNoFollow"
	ContainerService_WriteRawNoFollow_FullMethodName = "/bridgepb.ContainerService/WriteRawNoFollow"
	ContainerService_DeleteFile_FullMethodName       = "/bridgepb.ContainerService/DeleteFile"
	ContainerService_WatchDir_FullMethodName         = "/bridgepb.ContainerService/WatchDir"
)
...
type ContainerServiceClient interface {
	...
	ReverseHTTP(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReverseHTTPFrame, ReverseHTTPFrame], error)
	...
	ReadRawNoFollow(ctx context.Context, in *ReadRawNoFollowRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataChunk], error)
	WriteRawNoFollow(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[WriteRawNoFollowChunk, WriteRawResponse], error)
	DeleteFile(ctx context.Context, in *DeleteFileRequest, opts ...grpc.CallOption) (*DeleteFileResponse, error)
	// WatchDir streams coalesced change batches for one directory
	// (non-recursive). The stream ends when the watch fails or the caller
	// cancels; the watched directory disappearing surfaces as a final batch
	// naming the directory itself, then stream end.
	WatchDir(ctx context.Context, in *WatchDirRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WatchDirEvent], error)
}
...
func (c *containerServiceClient) ReverseHTTP(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReverseHTTPFrame, ReverseHTTPFrame], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[2], ContainerService_ReverseHTTP_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ReverseHTTPFrame, ReverseHTTPFrame]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_ReverseHTTPClient = grpc.BidiStreamingClient[ReverseHTTPFrame, ReverseHTTPFrame]
...
func (c *containerServiceClient) ReadRaw(ctx context.Context, in *ReadRawRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[3], ContainerService_ReadRaw_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *containerServiceClient) WriteRaw(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[WriteRawChunk, WriteRawResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[4], ContainerService_WriteRaw_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *containerServiceClient) ReadRawNoFollow(ctx context.Context, in *ReadRawNoFollowRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[5], ContainerService_ReadRawNoFollow_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ReadRawNoFollowRequest, DataChunk]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_ReadRawNoFollowClient = grpc.ServerStreamingClient[DataChunk]

func (c *containerServiceClient) WriteRawNoFollow(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[WriteRawNoFollowChunk, WriteRawResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[6], ContainerService_WriteRawNoFollow_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WriteRawNoFollowChunk, WriteRawResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_WriteRawNoFollowClient = grpc.ClientStreamingClient[WriteRawNoFollowChunk, WriteRawResponse]
...
func (c *containerServiceClient) WatchDir(ctx context.Context, in *WatchDirRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WatchDirEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContainerService_ServiceDesc.Streams[7], ContainerService_WatchDir_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WatchDirRequest, WatchDirEvent]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_WatchDirClient = grpc.ServerStreamingClient[WatchDirEvent]
...
type ContainerServiceServer interface {
	...
	ReverseHTTP(grpc.BidiStreamingServer[ReverseHTTPFrame, ReverseHTTPFrame]) error
	...
	// symbolic links. WriteRawNoFollow creates a new regular file and fails if
	// the final component already exists.
	ReadRawNoFollow(*ReadRawNoFollowRequest, grpc.ServerStreamingServer[DataChunk]) error
	WriteRawNoFollow(grpc.ClientStreamingServer[WriteRawNoFollowChunk, WriteRawResponse]) error
	DeleteFile(context.Context, *DeleteFileRequest) (*DeleteFileResponse, error)
	// WatchDir streams coalesced change batches for one directory
	// (non-recursive). The stream ends when the watch fails or the caller
	// cancels; the watched directory disappearing surfaces as a final batch
	// naming the directory itself, then stream end.
	WatchDir(*WatchDirRequest, grpc.ServerStreamingServer[WatchDirEvent]) error
...
func (UnimplementedContainerServiceServer) ReverseHTTP(grpc.BidiStreamingServer[ReverseHTTPFrame, ReverseHTTPFrame]) error {
	return status.Error(codes.Unimplemented, "method ReverseHTTP not implemented")
}
...
func (UnimplementedContainerServiceServer) ReadRawNoFollow(*ReadRawNoFollowRequest, grpc.ServerStreamingServer[DataChunk]) error {
	return status.Error(codes.Unimplemented, "method ReadRawNoFollow not implemented")
}
func (UnimplementedContainerServiceServer) WriteRawNoFollow(grpc.ClientStreamingServer[WriteRawNoFollowChunk, WriteRawResponse]) error {
	return status.Error(codes.Unimplemented, "method WriteRawNoFollow not implemented")
}
...
func (UnimplementedContainerServiceServer) WatchDir(*WatchDirRequest, grpc.ServerStreamingServer[WatchDirEvent]) error {
	return status.Error(codes.Unimplemented, "method WatchDir not implemented")
}
...
func _ContainerService_ReverseHTTP_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ContainerServiceServer).ReverseHTTP(&grpc.GenericServerStream[ReverseHTTPFrame, ReverseHTTPFrame]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_ReverseHTTPServer = grpc.BidiStreamingServer[ReverseHTTPFrame, ReverseHTTPFrame]
...
func _ContainerService_ReadRawNoFollow_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ReadRawNoFollowRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ContainerServiceServer).ReadRawNoFollow(m, &grpc.GenericServerStream[ReadRawNoFollowRequest, DataChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_ReadRawNoFollowServer = grpc.ServerStreamingServer[DataChunk]

func _ContainerService_WriteRawNoFollow_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ContainerServiceServer).WriteRawNoFollow(&grpc.GenericServerStream[WriteRawNoFollowChunk, WriteRawResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_WriteRawNoFollowServer = grpc.ClientStreamingServer[WriteRawNoFollowChunk, WriteRawResponse]
...
func _ContainerService_WatchDir_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(WatchDirRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ContainerServiceServer).WatchDir(m, &grpc.GenericServerStream[WatchDirRequest, WatchDirEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContainerService_WatchDirServer = grpc.ServerStreamingServer[WatchDirEvent]
...
var ContainerService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ReverseHTTP",
			Handler:       _ContainerService_ReverseHTTP_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
		...
		{
			StreamName:    "ReadRawNoFollow",
			Handler:       _ContainerService_ReadRawNoFollow_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "WriteRawNoFollow",
			Handler:       _ContainerService_WriteRawNoFollow_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "WatchDir",
			Handler:       _ContainerService_WatchDir_Handler,
			ServerStreams: true,
		},
	},
