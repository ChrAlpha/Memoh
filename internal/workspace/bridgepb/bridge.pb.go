...
func (ExecOutput_Stream) EnumDescriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *WatchDirEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WatchDirEvent) ProtoMessage() {}

func (x *WatchDirEvent) ProtoReflect() protoreflect.Message {
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WatchDirEvent.ProtoReflect.Descriptor instead.
func (*WatchDirEvent) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{1}
}

func (x *WatchDirEvent) GetPaths() []string {
	if x != nil {
		return x.Paths
	}
	return nil
...
type ListDirRequest struct {
	...
	MaxEntries    int32 `protobuf:"varint,6,opt,name=max_entries,json=maxEntries,proto3" json:"max_entries,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListDirRequest) GetMaxEntries() int32 {
	if x != nil {
		return x.MaxEntries
	}
	return 0
...
func (x *WriteRawChunk) GetAbort() bool {
	if x != nil {
		return x.Abort
	}
	return false
...
func (x *RenameRequest) Reset() {
	*x = RenameRequest{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenameRequest) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{33}
}
...
func (x *RenameResponse) Reset() {
	*x = RenameResponse{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenameResponse) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{34}
}
...
const file_internal_workspace_bridgepb_bridge_proto_rawDesc = "" +
	"\n" +
	"(internal/workspace/bridgepb/bridge.proto\x12\bbridgepb\"%\n" +
	"\x0fWatchDirRequest\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\"%\n" +
	"\rWatchDirEvent\x12\x14\n" +
	...
	"\x12collapse_threshold\x18\x05 \x01(\x05R\x11collapseThreshold\x12\x1f\n" +
	"\vmax_entries\x18\x06 \x01(\x05R\n" +
	"maxEntries\"\x93\x01\n" +
	"\tFileEntry\x12\x12\n" +
	...
	"\n" +
	"DeleteFile\x12\x1b.bridgepb.DeleteFileRequest\x1a\x1c.bridgepb.DeleteFileResponse\x12@\n" +
	"\bWatchDir\x12\x19.bridgepb.WatchDirRequest\x1a\x17.bridgepb.WatchDirEvent0\x01B6Z4github.com/memohai/memoh/internal/workspace/bridgepbb\x06proto3"
...
var file_internal_workspace_bridgepb_bridge_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_internal_workspace_bridgepb_bridge_proto_goTypes = []any{
	(ExecOutput_Stream)(0),         // 0: bridgepb.ExecOutput.Stream
	(*WatchDirRequest)(nil),        // 1: bridgepb.WatchDirRequest
	(*WatchDirEvent)(nil),          // 2: bridgepb.WatchDirEvent
	(*ReadFileRequest)(nil),        // 3: bridgepb.ReadFileRequest
	(*ReadFileResponse)(nil),       // 4: bridgepb.ReadFileResponse
	(*WriteFileRequest)(nil),       // 5: bridgepb.WriteFileRequest
	(*WriteFileResponse)(nil),      // 6: bridgepb.WriteFileResponse
	(*ListDirRequest)(nil),         // 7: bridgepb.ListDirRequest
	(*FileEntry)(nil),              // 8: bridgepb.FileEntry
	(*ListDirResponse)(nil),        // 9: bridgepb.ListDirResponse
	(*ExecInput)(nil),              // 10: bridgepb.ExecInput
	(*TerminalResize)(nil),         // 11: bridgepb.TerminalResize
	(*ExecOutput)(nil),             // 12: bridgepb.ExecOutput
	(*TunnelOpen)(nil),             // 13: bridgepb.TunnelOpen
	(*TunnelData)(nil),             // 14: bridgepb.TunnelData
	(*TunnelClose)(nil),            // 15: bridgepb.TunnelClose
	(*TunnelFrame)(nil),            // 16: bridgepb.TunnelFrame
	(*HTTPHeader)(nil),             // 17: bridgepb.HTTPHeader
	(*ReverseHTTPRequest)(nil),     // 18: bridgepb.ReverseHTTPRequest
	(*ReverseHTTPResponse)(nil),    // 19: bridgepb.ReverseHTTPResponse
	(*ReverseHTTPError)(nil),       // 20: bridgepb.ReverseHTTPError
	(*ReverseHTTPFrame)(nil),       // 21: bridgepb.ReverseHTTPFrame
	(*ReadRawRequest)(nil),         // 22: bridgepb.ReadRawRequest
	(*DataChunk)(nil),              // 23: bridgepb.DataChunk
	(*WriteRawChunk)(nil),          // 24: bridgepb.WriteRawChunk
	(*WriteRawResponse)(nil),       // 25: bridgepb.WriteRawResponse
	(*ReadRawNoFollowRequest)(nil), // 26: bridgepb.ReadRawNoFollowRequest
	(*WriteRawNoFollowChunk)(nil),  // 27: bridgepb.WriteRawNoFollowChunk
	(*DeleteFileRequest)(nil),      // 28: bridgepb.DeleteFileRequest
	(*DeleteFileResponse)(nil),     // 29: bridgepb.DeleteFileResponse
	(*StatRequest)(nil),            // 30: bridgepb.StatRequest
	(*StatResponse)(nil),           // 31: bridgepb.StatResponse
	(*MkdirRequest)(nil),           // 32: bridgepb.MkdirRequest
	(*MkdirResponse)(nil),          // 33: bridgepb.MkdirResponse
	(*RenameRequest)(nil),          // 34: bridgepb.RenameRequest
	(*RenameResponse)(nil),         // 35: bridgepb.RenameResponse
}
var file_internal_workspace_bridgepb_bridge_proto_depIdxs = []int32{
	8,  // 0: bridgepb.ListDirResponse.entries:type_name -> bridgepb.FileEntry
	11, // 1: bridgepb.ExecInput.resize:type_name -> bridgepb.TerminalResize
	0,  // 2: bridgepb.ExecOutput.stream:type_name -> bridgepb.ExecOutput.Stream
	13, // 3: bridgepb.TunnelFrame.open:type_name -> bridgepb.TunnelOpen
	14, // 4: bridgepb.TunnelFrame.data:type_name -> bridgepb.TunnelData
	15, // 5: bridgepb.TunnelFrame.close:type_name -> bridgepb.TunnelClose
	17, // 6: bridgepb.ReverseHTTPRequest.headers:type_name -> bridgepb.HTTPHeader
	17, // 7: bridgepb.ReverseHTTPResponse.headers:type_name -> bridgepb.HTTPHeader
	18, // 8: bridgepb.ReverseHTTPFrame.request:type_name -> bridgepb.ReverseHTTPRequest
	19, // 9: bridgepb.ReverseHTTPFrame.response:type_name -> bridgepb.ReverseHTTPResponse
	20, // 10: bridgepb.ReverseHTTPFrame.error:type_name -> bridgepb.ReverseHTTPError
	8,  // 11: bridgepb.StatResponse.entry:type_name -> bridgepb.FileEntry
	3,  // 12: bridgepb.ContainerService.ReadFile:input_type -> bridgepb.ReadFileRequest
	5,  // 13: bridgepb.ContainerService.WriteFile:input_type -> bridgepb.WriteFileRequest
	7,  // 14: bridgepb.ContainerService.ListDir:input_type -> bridgepb.ListDirRequest
	30, // 15: bridgepb.ContainerService.Stat:input_type -> bridgepb.StatRequest
	32, // 16: bridgepb.ContainerService.Mkdir:input_type -> bridgepb.MkdirRequest
	34, // 17: bridgepb.ContainerService.Rename:input_type -> bridgepb.RenameRequest
	10, // 18: bridgepb.ContainerService.Exec:input_type -> bridgepb.ExecInput
	16, // 19: bridgepb.ContainerService.Tunnel:input_type -> bridgepb.TunnelFrame
	21, // 20: bridgepb.ContainerService.ReverseHTTP:input_type -> bridgepb.ReverseHTTPFrame
	22, // 21: bridgepb.ContainerService.ReadRaw:input_type -> bridgepb.ReadRawRequest
	24, // 22: bridgepb.ContainerService.WriteRaw:input_type -> bridgepb.WriteRawChunk
	26, // 23: bridgepb.ContainerService.ReadRawNoFollow:input_type -> bridgepb.ReadRawNoFollowRequest
	27, // 24: bridgepb.ContainerService.WriteRawNoFollow:input_type -> bridgepb.WriteRawNoFollowChunk
	28, // 25: bridgepb.ContainerService.DeleteFile:input_type -> bridgepb.DeleteFileRequest
	1,  // 26: bridgepb.ContainerService.WatchDir:input_type -> bridgepb.WatchDirRequest
	4,  // 27: bridgepb.ContainerService.ReadFile:output_type -> bridgepb.ReadFileResponse
	6,  // 28: bridgepb.ContainerService.WriteFile:output_type -> bridgepb.WriteFileResponse
	9,  // 29: bridgepb.ContainerService.ListDir:output_type -> bridgepb.ListDirResponse
	31, // 30: bridgepb.ContainerService.Stat:output_type -> bridgepb.StatResponse
	33, // 31: bridgepb.ContainerService.Mkdir:output_type -> bridgepb.MkdirResponse
	35, // 32: bridgepb.ContainerService.Rename:output_type -> bridgepb.RenameResponse
	12, // 33: bridgepb.ContainerService.Exec:output_type -> bridgepb.ExecOutput
	16, // 34: bridgepb.ContainerService.Tunnel:output_type -> bridgepb.TunnelFrame
	21, // 35: bridgepb.ContainerService.ReverseHTTP:output_type -> bridgepb.ReverseHTTPFrame
	23, // 36: bridgepb.ContainerService.ReadRaw:output_type -> bridgepb.DataChunk
	25, // 37: bridgepb.ContainerService.WriteRaw:output_type -> bridgepb.WriteRawResponse
	23, // 38: bridgepb.ContainerService.ReadRawNoFollow:output_type -> bridgepb.DataChunk
	25, // 39: bridgepb.ContainerService.WriteRawNoFollow:output_type -> bridgepb.WriteRawResponse
	29, // 40: bridgepb.ContainerService.DeleteFile:output_type -> bridgepb.DeleteFileResponse
	2,  // 41: bridgepb.ContainerService.WatchDir:output_type -> bridgepb.WatchDirEvent
...
func file_internal_workspace_bridgepb_bridge_proto_init() {
	...
	file_internal_workspace_bridgepb_bridge_proto_msgTypes[15].OneofWrappers = []any{
		(*TunnelFrame_Open)(nil),
		(*TunnelFrame_Data)(nil),
		(*TunnelFrame_Close)(nil),
	}
	file_internal_workspace_bridgepb_bridge_proto_msgTypes[20].OneofWrappers = []any{
